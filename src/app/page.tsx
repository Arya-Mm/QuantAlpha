          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <div className="flex items-center justify-end gap-1.5 font-body-sm text-body-sm text-emerald-800 font-semibold">
              ...
              <div className="text-right">
                ...
                <div className="flex items-center justify-end gap-1 font-body-sm text-body-sm text-stone-700 font-medium">
                  8m ago{" "}
        ...
        <main className="p-6 flex-1 max-w-[1600px] w-full mx-auto flex flex-col gap-6">
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="flex gap-3">
              ...
              <button className="bg-white border border-[#d6d3d1] text-stone-700 font-body-sm text-body-sm font-semibold px-4 py-2 hover:bg-[#eeeeea] hover:text-stone-900 transition-all rounded-lg active:scale-98 cursor-pointer flex items-center gap-1.5 shadow-2xs">
          ...
          <div className="flex gap-2 items-center overflow-x-auto pb-1">
            <div className="card-panel p-4 flex-1 min-w-[200px] hover:border-orange-300 transition-colors cursor-pointer bg-white">
              ...
              <div className="font-body-sm text-body-sm text-stone-600 mb-0.5 font-medium">
                12 datasets
              </div>
              <div className="font-label-caps text-[10px] text-stone-400 font-medium">
                Updated 8m ago
              </div>
            </div>
          ...
          <div className="card-panel p-5 flex justify-between items-center bg-white divide-x divide-[#f0f0ec] tracking-tight shadow-xs">
            ...
            <div className="px-4 last:pr-0">
              ...
              <div className="metric-value text-stone-900">13.2%</div>
            </div>
          </div>
              ...
              <div className="card-panel flex flex-col h-[400px] bg-white">
                <div className="p-4 border-b border-[#e5e5df] flex items-center justify-between bg-[#f8f8f6]/70">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex bg-[#eeeeea] rounded-lg p-0.5">
                      <button className="px-2.5 py-1 text-[11px] font-semibold rounded-md text-stone-600 hover:text-stone-900">
                        1Y
                      </button>
                      <button className="px-2.5 py-1 text-[11px] font-semibold rounded-md text-stone-600 hover:text-stone-900">
                        3Y
                    ...
                    <button className="p-1 rounded text-stone-400 hover:text-stone-700 hover:bg-[#eeeeea]">
                ...
                <div className="flex-1 p-4 relative bg-[#fbfbfa]">
                  <div className="absolute top-4 left-4 flex gap-4 font-body-sm text-body-sm z-10">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-semibold text-stone-900">Validated Strategy</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="w-3 h-1 bg-stone-400 rounded-full"></span>{" "}
                      <span className="text-stone-500 font-medium">Benchmark (NIFTY 50)</span>
                    </div>
                  </div>
                  <div className="w-full h-full border-b border-l border-[#d6d3d1] relative mt-8">
                    <div className="absolute inset-0 pointer-events-none">
                      <div className="absolute inset-0 grid grid-cols-12 divide-x divide-[#e5e5df]/60">
                        <div></div>
                        <div></div>
                        <div></div>
                        <div></div>
                    ...
                    <div className="absolute -left-10 top-[25%] text-[10px] text-stone-400 font-mono">
                      100%
                    </div>
                    <div className="absolute -left-10 top-[50%] text-[10px] text-stone-400 font-mono">
                      50%
                    </div>
                    <div className="absolute -left-10 top-[75%] text-[10px] text-stone-400 font-mono">
                      0%
                    </div>
                ...
                <div className="p-4 bg-[#f8f8f6] flex justify-between border-t border-[#e5e5df]">
                  <div>
                    ...
                    <div className="metric-value-sm text-emerald-800 font-bold">18.7%</div>
                  </div>
                  <div>
                    <div className="metric-label text-[10px]">
                      Ann. Volatility
                    </div>
                    <div className="metric-value-sm text-stone-800">13.2%</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="metric-value-sm text-stone-800 font-bold">2.11</div>
                  </div>
                  <div>
                    <div className="metric-label text-[10px]">MDD</div>
                    <div className="metric-value-sm text-rose-800 font-bold">-8.3%</div>
                  </div>
                  <div>
                    <div className="metric-label text-[10px]">Turnover</div>
                    <div className="metric-value-sm text-stone-800">68.4%</div>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <table className="w-full text-left whitespace-nowrap">
                    ...
                    <tbody>
                      <tr className="hover:bg-[#f5f5f2] transition-colors group">
                        <td className="table-cell pl-4 font-semibold text-stone-900">
                          Momentum 21D
                        </td>
                        <td className="table-cell text-stone-500 font-medium">
                          Technical
                        </td>
                        <td className="table-cell font-data-metric-sm font-mono text-stone-800">0.067</td>
                        <td className="table-cell font-data-metric-sm font-mono text-stone-800">0.61</td>
                      ...
                      <tr className="hover:bg-[#f5f5f2] transition-colors">
                        ...
                        <td className="table-cell font-data-metric-sm font-mono text-stone-800">0.041</td>
                        <td className="table-cell font-data-metric-sm font-mono text-stone-800">0.38</td>
                        <td className="table-cell pr-4">
                      ...
                      <tr className="hover:bg-[#f5f5f2] transition-colors">
                        ...
                        <td className="table-cell font-data-metric-sm font-mono text-stone-800">0.018</td>
                        <td className="table-cell font-data-metric-sm font-mono text-stone-800">0.21</td>
                        <td className="table-cell pr-4">
                      ...
                      <tr className="hover:bg-[#f5f5f2] transition-colors group">
                        ...
                        <td className="table-cell font-data-metric-sm font-mono text-stone-800">0.032</td>
                        <td className="table-cell font-data-metric-sm font-mono text-stone-800">0.31</td>
                        <td className="table-cell pr-4">
                          <span className="status-badge-warn">CONDITIONAL</span>
                        </td>
                      </tr>
