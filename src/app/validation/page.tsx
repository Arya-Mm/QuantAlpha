...
type RunResult = { progress?: number; stage?: string; result?: { status?: string; validation_method?: string; strategy_definition?: { rule?: string; fast_period?: number; slow_period?: number; horizon?: number }; data_summary?: { ticker?: string; observations?: number; trade_days?: number; turnover_events?: number; transaction_cost_rate?: number }; validation_details?: { dsr?: number | null; dsr_status?: string; pbo?: number | null; pbo_status?: string; sharpe_ratio?: number | null; n_cpcv_paths?: number; n_samples?: number; mode?: string } } };
