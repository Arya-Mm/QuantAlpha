  ...
  const [activityLogs, setActivityLogs] = useState<ActivityLogEvent[]>([
    {
      ...
      timestamp: "15:28:42",
      agent: "Risk",
      action: "Pre-Trade Risk Checks Verified",
      evidence: "All 6 hardware latch constraints within SEBI & institutional limits.",
      status: "success",
    },
    {
      id: "evt-init-2",
      timestamp: "15:28:40",
      agent: "Execution",
      action: "TWAP Slice Router Active: INFY.NS",
      evidence: "250 shares scheduled across 5-minute VWAP interval to minimize slippage.",
      status: "info",
    },
    {
      id: "evt-init-3",
      timestamp: "15:25:12",
      agent: "Strategy",
      action: "Alpha Signal Evaluated: Momentum Reversion",
      evidence: "Z-Score -2.18 on Reliance 15m VWAP reversion. Sizing: 450 shares.",
      status: "info",
    },
    {
      id: "evt-init-4",
      timestamp: "15:20:00",
      agent: "Portfolio",
      action: "Kelly Volatility Rebalance",
      evidence: "Adjusted cash reserve to 21.1% based on 30-day realized covariance matrix.",
      status: "success",
    },
  ]);

  const [riskConstraints] = useState<RiskGateConstraint[]>([
    { name: "Max Single Stock Allocation", limit: "≤ 5.0%", currentValue: "2.4%", status: "APPROVED" },
    { name: "Portfolio Beta Neutrality", limit: "[-0.10, +0.10]", currentValue: "+0.04", status: "APPROVED" },
    { name: "Sector Exposure Cap", limit: "≤ 15.0%", currentValue: "11.2%", status: "APPROVED" },
    { name: "Max Portfolio Drawdown Stop", limit: "≤ 8.0%", currentValue: "2.1%", status: "APPROVED" },
    { name: "Gross Leverage Cap", limit: "≤ 1.50x", currentValue: "0.79x", status: "APPROVED" },
    { name: "Minimum Cash Reserve", limit: "≥ 15.0%", currentValue: "21.1%", status: "APPROVED" },
  ]);
