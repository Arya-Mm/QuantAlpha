...
export const INITIAL_VALIDATED_SIGNALS: import("../types/quant").SignalItem[] = [
  {
    ...
    formula: "Slope_t = Yield_{10Y, t} - Yield_{2Y, t}, \\quad Shift_t = \\Delta Slope_t",
  },
  {
    id: "sig-val-2",
    ...
    formula: "Pos_t = \\min(1.0, \\sigma_{target} / \\hat{\\sigma}_{20,t}) \\cdot sign(P_t - VWAP_{20})",
  },
];
